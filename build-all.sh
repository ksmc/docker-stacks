...
cd r-notebook
docker build -t $ACR_NAME.azurecr.io/r-notebook:latest --build-arg BASE_CONTAINER=$ACR_NAME.azurecr.io/base-notebook:latest .
docker push $ACR_NAME.azurecr.io/r-notebook:latest
cd ..
...
docker build -t $ACR_NAME.azurecr.io/openrefine-notebook:latest --build-arg BASE_CONTAINER=$ACR_NAME.azurecr.io/base-notebook:latest .
docker push $ACR_NAME.azurecr.io/openrefine-notebook:latest
cd ..
...
cd rstudio-notebook
docker build -t $ACR_NAME.azurecr.io/rstudio-notebook:latest --build-arg BASE_CONTAINER=$ACR_NAME.azurecr.io/r-notebook:latest .
docker push $ACR_NAME.azurecr.io/rstudio-notebook:latest
cd ..
...
cd sas-notebook
docker build -t $ACR_NAME.azurecr.io/sas-notebook:latest --build-arg BASE_CONTAINER=$ACR_NAME.azurecr.io/scipy-notebook:latest .
docker push $ACR_NAME.azurecr.io/sas-notebook:latest
cd ..

cd theia-notebook
docker build -t $ACR_NAME.azurecr.io/theia-notebook:latest --build-arg BASE_CONTAINER=$ACR_NAME.azurecr.io/scipy-notebook:latest .
docker push $ACR_NAME.azurecr.io/theia-notebook:latest
cd ..
